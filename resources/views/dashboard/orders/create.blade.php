    ...
    <form action="{{ route('orders.store') }}" method="POST">
        ...
        <div class="space-y-6 divide-y divide-gray-200">
            <div class="mb-4 pb-4 border-b border-gray-200">
                ...
                <input type="text" value="{{ Auth::user()->name }}" class="mt-1 block w-full rounded-md border-gray-300 bg-gray-100" readonly>
        ...
        <div class="flex justify-between mt-6">
            <a href="{{ route('user.products.index') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-800 px-4 py-2 rounded-lg font-medium transition duration-150 ease-in-out">Back to Products</a>
